...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const helpers = {
      neighboursFor, tasksOf, sortTasks, packInfo, applyToEach, recallLaunch, rememberLaunch, stillOffered,
          ...
          React.createElement('input', {
            ...
            onChange: async (e) => {
              ...
              try {
                ...
                const out = await api('/import', { method: 'POST', body: JSON.stringify(input) })
