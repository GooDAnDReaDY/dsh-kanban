...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css =
      ...
      '.dkb-filterChipActive{background:var(--dsw-alias-state-business-primary);color:#fff;border-color:transparent;font-weight:600}' +
      ...
      '.dkb-consolePre{background:#0d1117;color:#58a6ff;padding:12px;border-radius:8px;font-family:monospace;font-size:11px;max-height:260px;overflow-y:auto;white-space:pre-wrap;border:1px solid #30363d}'
    ...
    function KanbanSettingsCard(props) {
      ...
      if (!open) return h('li', { className: 'dkb-card' }, head)
      ...
      return h('li', { className: 'dkb-card dkb-cardOpen' },
        head, h('div', { className: 'dkb-body' }, body))
    }
                ...
                h('div', { style: { display: 'flex', gap: 8 } },
                  ...
                  openTask.owner && openTask.repo
                    ? h('button', {
                        type: 'button', className: 'dkb-save',
                        disabled: prCreating,
                        style: { background: 'var(--dsw-alias-state-info-primary, #0969da)', color: '#fff' },
                        onClick: async () => {
                          setPrCreating(true)
                          try {
                  ...
                  createdPr
                    ? h('a', {
                        className: 'dkb-save',
                        style: { background: 'var(--dsw-alias-state-success-primary, #16a34a)', color: '#fff', textDecoration: 'none', display: 'inline-flex', alignItems: 'center' },
