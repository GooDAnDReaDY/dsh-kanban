  ...
  factory: (require) => {
    ...
    function KanbanSettingsCard(props) {
      ...
      if (props && props.view === 'summary') {
        return h('span', { className: 'dkb-sub' }, t('settings.subtitle') || 'Kanban board for sessions and tasks')
      }
      const page = !!(props && props.view === 'page')

      return h(page ? 'div' : 'li', { className: page ? 'dkb-page' : 'dkb-card dkb-cardOpen' },
        page ? null : head, h('div', { className: 'dkb-body' }, body))
    }
    ...
    function apply(ctx) {
      ...
      try {
        ...
        console.warn('[dsh-kanban] plugins.item seat unavailable', e)
      }
