...
const WRITABLE = [
  ...
  'cron', 'nextRunAt', 'lastRunAt', 'progressDump', 'permission', 'reasoningEffort', 'permissionConfirmedAt', 'runs', 'checklist', 'report', 'comments', 'rejectReason', 'rejectedAt',
]
...
function rowToTask(row) {
  ...
  const { col, labels, waiting, labelColors, runs, checklist, report, comments, rejectReason, rejectedAt, ...rest } = row
  let parsedChecklist = []
  try {
    ...
    createTask(input) {
      ...
      db.prepare(`INSERT INTO tasks
        (id, board, col, position, title, body, owner, repo, issueNumber, issueUrl,
         ...
         checklist, report, comments, rejectReason, rejectedAt, reasoningEffort)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).run(
